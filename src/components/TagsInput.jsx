  ...
  return (
    <div>
      <div
        ...
        className='border-2 bg-transparent dark:border-dark-subtle border-light-subtle px-2 h-10 rounded w-full dark:text-white text-primary flex item-center space-x-2 overflow-x-auto custom-scroll-bar transition'
      >
        {tags.map((t) => (
